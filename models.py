...
class Almacen(models.Model):
    ...
    empcod = models.ForeignKey('Granja', models.DO_NOTHING, db_column='EmpCod', to_field='EmpCod', related_name='almacen_empcod_set')  # Field name made lowercase.
...
class CabeceraPedido(models.Model):
    ...
    gracod = models.ForeignKey(Almacen, models.DO_NOTHING, db_column='GraCod', to_field='GraCod', related_name='cabecerapedido_gracod_set')  # Field name made lowercase.
    empcod = models.ForeignKey(Almacen, models.DO_NOTHING, db_column='EmpCod', to_field='EmpCod', related_name='cabecerapedido_empcod_set')  # Field name made lowercase.
...
class DetallesDePedido(models.Model):
    ...
    procod = models.ForeignKey(CabeceraPedido, models.DO_NOTHING, db_column='ProCod', to_field='ProCod', related_name='detallesdepedido_procod_set')  # Field name made lowercase.
    almcod = models.ForeignKey(CabeceraPedido, models.DO_NOTHING, db_column='AlmCod', to_field='AlmCod', related_name='detallesdepedido_almcod_set')  # Field name made lowercase.
    gracod = models.ForeignKey(CabeceraPedido, models.DO_NOTHING, db_column='GraCod', to_field='GraCod', related_name='detallesdepedido_gracod_set')  # Field name made lowercase.
    empcod = models.ForeignKey(CabeceraPedido, models.DO_NOTHING, db_column='EmpCod', to_field='EmpCod', related_name='detallesdepedido_empcod_set')  # Field name made lowercase.
