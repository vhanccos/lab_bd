...
class Empresa(models.Model):
    ...
    paicod = models.ForeignKey(Ciudad, models.DO_NOTHING, db_column='PaiCod', to_field='PaiCod', related_name='empresa_paicod_set')  # Field name made lowercase.
...
class Granja(models.Model):
    ...
    paicod = models.ForeignKey(Ciudad, models.DO_NOTHING, db_column='PaiCod', to_field='PaiCod', related_name='granja_paicod_set', blank=True, null=True)  # Field name made lowercase.
...
class Proveedores(models.Model):
    ...
    ciucod = models.ForeignKey(Ciudad, models.DO_NOTHING, db_column='CiuCod', blank=True, null=True)  # Field name made lowercase.
    paicod = models.ForeignKey(Ciudad, models.DO_NOTHING, db_column='PaiCod', to_field='PaiCod', related_name='proveedores_paicod_set', blank=True, null=True)  # Field name made lowercase.
